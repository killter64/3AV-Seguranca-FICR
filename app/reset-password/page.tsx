...
/**
 * Página de Definição de Nova Senha (Reset Password - Etapa 2)
 * 
 * Fluxo Real:
 * 1. Usuário clica no link do email de recuperação e é autenticado temporariamente.
 * 2. É redirecionado para esta página.
 * 3. Preenche a nova senha atendendo à política de força (Zod).
 * 4. Ao submeter, o Supabase realiza o hash bcrypt + salt de forma automática e segura no servidor.
 * 5. Redireciona o usuário para /login para que ele acesse com a nova credencial e passe pelo MFA.
 */
export default function ResetPasswordPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Escolha uma senha forte para sua segurança"
    >
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <Card className="border-emerald-500/20 bg-emerald-500/5 p-3">
            <p className="text-xs text-emerald-300 leading-relaxed">
              ...
              automaticamente com bcrypt e salt no servidor do Supabase. O frontend não executa
              hashing simulado e os cookies de sessão de recuperação são gerenciados com flags seguras.
            </p>
          </Card>
