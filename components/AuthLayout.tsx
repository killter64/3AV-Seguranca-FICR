...
/**
 * Layout Principal para Telas de Autenticação
 * 
 * Exibe:
 * - Logo com ícone Shield (segurança)
 * - Card centralizado
 * - Subtítulo/descrição
 * - Conteúdo (formulários)
 * 
 * Tema: Dark mode cybersegurança
 * - Azul-marinho profundo (oklch(0.15 0.05 250))
 * - Verde-neon accent (oklch(0.75 0.18 155))
 */
